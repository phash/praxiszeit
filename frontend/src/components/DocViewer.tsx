  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>Im Wochen-Editor verteilen Sie <strong>Zeitslots</strong> per Drag &amp; Drop oder Klick über die Woche und ziehen <strong>Mitarbeitende</strong> aus der Liste auf einen Slot. Optional setzen Sie pro Slot eine <strong>Mindestbesetzung</strong>; unterbesetzte Slots werden markiert (weiche Warnung, blockiert nicht). Im Slot-Dialog gibt es außerdem das Feld <strong>„Hinweis (optional)"</strong> (bis zu 500 Zeichen), z. B. „Einarbeitung Azubi" – der Text erscheint mit vorangestelltem <strong>»</strong> im Wochenraster und im PDF-Ausdruck, rein informativ ohne Auswirkung auf Berechnungen. <strong>Achtung:</strong> Der Hinweis ist für alle Mitarbeitenden mit Plansicht lesbar und wird beim PDF-Aushang mitgedruckt – keine Gesundheitsangaben oder anderen sensiblen Daten hineinschreiben.</p>
