  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>Über den Knopf <strong>„Bearbeiten"</strong> (Stift-Symbol) in der Werkzeugleiste des Plan-Editors öffnen Sie die <strong>Plan-Einstellungen</strong>; dort gibt es zusätzlich den Schalter <strong>„Für Mitarbeitende sichtbar"</strong>. Er macht den Plan in der Mitarbeiteransicht sichtbar, <strong>auch wenn er heute noch nicht gilt</strong> – praktisch, um z. B. einen ab September geltenden Plan schon vorher bekannt zu machen. Ein heute aktiver bzw. im Datums-Fenster liegender Plan ist ohnehin sichtbar; der Schalter betrifft nur den Fall davor.</p>
