...
export const handbuchMitarbeiterSections: AccordionItem[] = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p>Wenn Ihre Praxis die <strong>Schichtplanung</strong> nutzt, finden Sie links den Menüpunkt <strong>Schichtplan</strong>. Dort sehen Sie die für Sie sichtbaren Wochenpläne als Übersicht: welcher Arbeitsplatz (z. B. Tresen, Labor) zu welcher Zeit besetzt ist und wer eingeteilt ist. Sichtbar sind Pläne, die heute gelten, sowie Pläne, die Ihr Administrator ausdrücklich <strong>für Mitarbeitende freigegeben</strong> hat – auch wenn sie erst künftig gelten. Sind mehrere Pläne sichtbar, steht oben eine Auswahl; ein noch nicht geltender Plan ist mit dem Hinweis „Dieser Plan gilt noch nicht – er ist zur Ansicht freigegeben." als Vorschau gekennzeichnet.</p>
        <p>Manche Einteilungen tragen einen <strong>Hinweis</strong> (z. B. „Einarbeitung Azubi"), erkennbar am vorangestellten <strong>»</strong>. Über den Knopf <strong>„PDF"</strong> drucken Sie den gerade angezeigten Plan als Aushang aus.</p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>Im Wochen-Editor verteilen Sie <strong>Zeitslots</strong> per Drag &amp; Drop oder Klick über die Woche und ziehen <strong>Mitarbeitende</strong> aus der Liste auf einen Slot. Optional setzen Sie pro Slot eine <strong>Mindestbesetzung</strong>; unterbesetzte Slots werden markiert (weiche Warnung, blockiert nicht). Im Slot-Dialog gibt es außerdem das Feld <strong>„Hinweis (optional)"</strong> (bis zu 500 Zeichen), z. B. „Einarbeitung Azubi" – der Text erscheint mit vorangestelltem <strong>»</strong> im Wochenraster und im PDF-Ausdruck, rein informativ ohne Auswirkung auf Berechnungen.</p>
        ...
        <p>In den <strong>Plan-Einstellungen</strong> (Zahnrad im Plankopf) gibt es zusätzlich den Schalter <strong>„Für Mitarbeitende sichtbar"</strong>. Er macht den Plan in der Mitarbeiteransicht sichtbar, <strong>auch wenn er heute noch nicht gilt</strong> – praktisch, um z. B. einen ab September geltenden Plan schon vorher bekannt zu machen. Ein heute aktiver bzw. im Datums-Fenster liegender Plan ist ohnehin sichtbar; der Schalter betrifft nur den Fall davor.</p>
        <p>Der Knopf <strong>„PDF"</strong> in der Werkzeugleiste erzeugt einen Aushang im Querformat mit einer Tabelle Arbeitsplatz × Wochentag – zum Aushängen am Schwarzen Brett. Auch Mitarbeitende können darüber den Plan drucken, den sie in ihrer Ansicht sehen.</p>
