      ...
      <section>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700">⚠️ Arbeitstage-only-Änderung (gleiche Wochenstunden, andere Arbeitstage) ist im Verlaufs-/Berichtstext unauffällig: bei „Gleichmäßig" verschiebt sich trotzdem still das Tagessoll, bei „Nach Tagen" nur der Urlaubsverbrauch (ein wegfallender Wochentag zählt einen dort schon gebuchten Urlaubstag rückwirkend nicht mehr). Deshalb vor dem Speichern immer die Vorschau prüfen, nicht nur die Wochenstundenzahl.</p>
          </div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-amber-700">⚠️ <strong>Arbeitstage-only-Änderung ist unauffällig:</strong> Ändern Sie bei „Gleichmäßig" nur die Arbeitstage pro Woche bei gleichbleibenden Wochenstunden, zeigen Verlauf und Berichte weiterhin dieselbe Wochenstundenzahl – das Tagessoll verschiebt sich dabei trotzdem still (z. B. 40 h auf 5 Tage → 40 h auf 4 Tage: 8 h/Tag → 10 h/Tag). Verschieben Sie bei „Nach Tagen" Stunden auf einen anderen Wochentag, ohne die Wochensumme zu ändern, bleibt das Tagessoll der übrigen Tage gleich – hier ändert sich stattdessen der <strong>Urlaubsverbrauch</strong>: ein am wegfallenden Wochentag bereits gebuchter Urlaubstag zählt rückwirkend nicht mehr. Vor dem Speichern deshalb immer die Vorschau prüfen, nicht nur die angezeigte Wochenstundenzahl.</p>
