      ...
      <section>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Benutzer bearbeiten → Button „Wochenstunden anpassen…" (oder Uhr-Symbol in der Liste) → neue Wochenstunden + „Gültig ab"-Datum → historische Salden bleiben korrekt. Wochenstunden sind im Formular nur noch Anzeige, Verlauf zeigt „ab … bis …".</p>
            <p className="text-sm text-gray-600">Sind im Wirkungszeitraum Abwesenheiten gebucht – bei rückwirkendem wie bei zukünftigem Datum –, zeigt der Dialog vorab Zeitraum, altes/neues Tagessoll und betroffene Abwesenheiten, deren Stunden nach Bestätigung umgerechnet werden (Urlaubstage bleiben unverändert). Löschen rechnet zurück; die früheste Änderung ist erst löschbar, wenn keine späteren mehr bestehen. Bei individuellem Tagesplan gibt es keinen Verlauf – dort bleibt das Wochenstunden-Feld direkt editierbar.</p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p><strong>Voraussichtlicher Stand zum Jahresende:</strong> Saldo bis heute abzüglich der Stunden Ihrer bereits eingetragenen künftigen Überstundenausgleich-Tage bis zum 31.12. Urlaub, Krankheit und Fortbildung senken das Konto nicht und zählen deshalb nicht mit.</p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>Für Teilzeit-Anpassungen: Benutzer öffnen → Button „<strong>Wochenstunden anpassen…</strong>" (oder Uhr-Symbol in der Benutzerliste) → neue Wochenstunden + <strong>„Gültig ab"</strong>-Datum eintragen. Die Wochenstundenzahl ist im Bearbeiten-Formular nur noch Anzeige, keine Direkteingabe mehr; historische Salden bleiben korrekt, der Verlauf zeigt „ab … bis …". Sind im Wirkungszeitraum bereits Abwesenheiten gebucht, zeigt der Dialog vorab Zeitraum, altes/neues Tagessoll und betroffene Abwesenheiten – nach Bestätigung werden deren Stunden auf das neue Tagessoll umgerechnet, bei rückwirkendem <strong>und</strong> bei zukunftsdatiertem Wirkungsdatum (Ausnahme: Überstundenausgleich und Mitarbeitende ohne Stundenzählung; Urlaubs<strong>tage</strong> bleiben unverändert, Tagesprinzip). Ein bereits abgeschlossenes Jahr wird dabei nur gemeldet, nicht neu berechnet. Löschen einer Änderung rechnet die Stunden ebenso zurück; die <strong>früheste</strong> Änderung lässt sich erst löschen, wenn keine späteren mehr bestehen. Bei individuellem Tagesplan gibt es keinen Verlauf – dort kommt das Tagessoll aus den Tagesstunden und das Wochenstunden-Feld bleibt ein normales Eingabefeld (reine Vertragsangabe für Berichtsköpfe/Auswertungen). Checkboxen: „ArbZG-Prüfungen aussetzen" für §18, „Nachtarbeitnehmer" für §6, „<strong>Nimmt an Betriebsferien teil</strong>" (Standard an, rollenunabhängig – für reine Verwaltungs-Accounts abwählbar), „Stundenzählung" aus für MA ohne Zeiterfassung (Urlaub/Krank zählen trotzdem tagebasiert).</p>
  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        ...
        <p className="text-sm text-gray-500 mt-1"><strong>Feste Monatsarbeitszeit (Minijob-Modus, #377 Baustein 2b):</strong> Bei aktivem Arbeitszeitkonto können Sie zusätzlich „Feste Monatsarbeitszeit (Monats-Soll = vereinbarte Monatsarbeitszeit)" aktivieren – dann macht die vereinbarte Monatszeit zur <strong>Pflichtangabe</strong> und wird jeden Monat fest als Soll gesetzt (anteilig bei unterjährigem Ein-/Austritt), statt aus Wochenstunden/Arbeitstagen zu schwanken. Die Tagesstunden-Matrix wird dann zur „geplanten Anwesenheit": Feiertag, Urlaub oder bezahlte Freistellung auf einem geplanten Tag schreiben die geplanten Stunden dem Ist gut; ein unbezahlt entschuldigter Tag (Sonstiges) mindert stattdessen das feste Soll. Weiche Warnung, wenn das Monats-Ist die vereinbarte Zeit übersteigt. <strong>Bekannte Grenze:</strong> Liegen die geplanten Tagesstunden deutlich unter der Monatszeit, deckt die Gutschrift bei einem <em>ganzen</em> Fehlmonat (Urlaub/Krank) nur den geplanten Anteil ab – der flexible Rest bleibt Konto-Defizit und braucht eine manuelle Korrektur; einzelne Fehltage sind korrekt.</p>
      </section>
