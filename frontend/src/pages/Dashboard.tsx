...
export default function Dashboard() {
  ...
  return (
    <div className="page-enter">
      ...
      {/* Stat Pills - Mobile */}
      <div className={`grid ${trackHours ? 'grid-cols-3' : 'grid-cols-2'} gap-3 mb-6 md:hidden`}>
        {trackHours && (
      ...
      <div className="mb-4 flex justify-center">
        ...
        >
          {showDetails ? (
            ...
            <>
              <ChevronDown size={16} />
              <span>Details anzeigen ({trackHours ? 'Jahresübersicht & Team-Kalender' : 'Team-Kalender'})</span>
            </>
          )}
        </button>
      </div>
      ...
      {showDetails && (
        <>
          {/* Yearly Overview */}
          {(yearlyAbsences || (trackHours && ytdOvertime)) && (
